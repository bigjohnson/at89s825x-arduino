...
if ih.addresses()[len(ih.addresses()) - 1]  >= at89s8252_max_program:
    print('The file is too large ' + hex(ih.addresses()[len(ih.addresses()) - 1]) + '!')
    print('Max space is ' + hex(at89s8252_max_program) + ' bytes, extra data will be ignored!')
...
#    a = input('Programming done. Do you wish to verify? y/n: ')
    ...
    if not err:
        ...
        print('Program verification issue.')
